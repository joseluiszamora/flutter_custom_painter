...
class _HeaderDiagonalPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // lapiz.style = PaintingStyle.stroke; // pinta una linea
    lapiz.style = PaintingStyle.fill; // rellena el contenido
    lapiz.strokeWidth = 2;
...
class _HeaderWaveGradientPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final Rect rect =
        new Rect.fromCircle(center: const Offset(0.0, 55.0), radius: 180);
